...
const SecureInvariantTargetBounty = artifacts.require(
  'SecureInvariantTargetBounty'
)
const InsecureInvariantTargetBounty = artifacts.require(
...
const sendReward = async (from, to, value) =>
  ethSendTransaction({
    from,
    to,
    value
