...
const IncreasingPriceCrowdsale = artifacts.require(
  'IncreasingPriceCrowdsaleImpl'
)
const SimpleToken = artifacts.require('SimpleToken')

contract('IncreasingPriceCrowdsale', function([
  _,
  investor,
  wallet,
  purchaser
  ...
  describe('rate during crowdsale should change at a fixed step every block', async function() {
    ...
    context('with crowdsale', function() {
      ...
      it('should have initial and final rate', async function() {
        ;(await this.crowdsale.initialRate()).should.be.bignumber.equal(
          initialRate
        )
