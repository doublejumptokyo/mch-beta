...
contract('ERC20Pausable', function([
  _,
  pauser,
  otherPauser,
  recipient,
  ...
  describe('pausable token', function() {
    ...
    describe('transfer', function() {
      ...
      it('reverts when trying to transfer when paused', async function() {
        ...
        await assertRevert(
          this.token.transfer(recipient, 100, { from: pauser })
        )
      })
    })
    ...
    describe('approve', function() {
      ...
      it('reverts when trying to transfer when paused', async function() {
        ...
        await assertRevert(
          this.token.approve(anotherAccount, 40, { from: pauser })
        )
      })
    })
    ...
    describe('transfer from', function() {
      ...
      it('allows to transfer from when unpaused', async function() {
        await this.token.transferFrom(pauser, recipient, 40, {
          from: anotherAccount
        })
      ...
      it('reverts when trying to transfer from when paused', async function() {
        ...
        await assertRevert(
          this.token.transferFrom(pauser, recipient, 40, {
            from: anotherAccount
          })
        )
      })
    ...
    describe('decrease approval', function() {
      ...
      it('reverts when trying to transfer when paused', async function() {
        ...
        await assertRevert(
          this.token.decreaseAllowance(anotherAccount, 40, { from: pauser })
        )
      })
    })
