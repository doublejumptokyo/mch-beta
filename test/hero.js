...
contract('Hero', function(accounts) {
  ...
  it('setHeroManagerAddress to heroAsset', function() {
    return HeroManager.deployed().then(async function(hm) {
      return HeroAsset.deployed()
        .then(async function(hs) {
          await hs.addMinter(hm.address, { from: accounts[0] })
      ...
      return Hero.deployed()
        ...
        .then(function(val) {
          ...
          assert.equal(
            val[4][0],
            initialActiveSkill,
            'Hero initialActiveSkillnot set'
          )
  ...
  it('setAlias', function() {
    return HeroManager.deployed().then(async function(hm) {
      return Hero.deployed()
        .then(async function(instance) {
          await hm.setAlias(sampleHeroId, alias, { from: accounts[0] })
          return instance.getHero(sampleHeroId)
        })
        .then(function(val) {
  ...
  it('setIpfsType', function() {
    return Hero.deployed()
      .then(async function(instance) {
        await instance.setIpfsType(Ipfs2, IpfsType, { from: accounts[0] })
  ...
  it('addExperience up to 20, and phy:31, int:31, agi: 31', function() {
    return HeroManager.deployed().then(async function(hm) {
      return Hero.deployed()
        .then(async function(instance) {
          await hm.addExperience(sampleHeroId, 3215, { from: accounts[0] })
          return instance.getHero(sampleHeroId)
        })
        .then(function(val) {
  ...
  it('setIpfs, and phy:35, int:31, agi: 26', function() {
    return HeroManager.deployed().then(async function(hm) {
      return Hero.deployed()
        .then(async function(instance) {
          await hm.setIpfs(sampleHeroId, Ipfs2, { from: accounts[0] })
          return instance.getHero(sampleHeroId)
        })
        .then(function(val) {
  ...
  it('addExperience up to 100, and phy:127, int:111, agi: 94', function() {
    return HeroManager.deployed().then(async function(hm) {
      return Hero.deployed()
        .then(async function(instance) {
          await hm
            .addExperience(sampleHeroId, 220416, { from: accounts[0] })
  ...
  it('addItem', function() {
    return HeroManager.deployed().then(async function(hm) {
      return Hero.deployed()
        .then(async function(instance) {
          await hm.addItem(sampleHeroId, 0, 1, { from: accounts[0] })
          await hm.addItem(sampleHeroId, 1, 2, { from: accounts[0] })
          await hm.addItem(sampleHeroId, 2, 3, { from: accounts[0] })
          await hm.addItem(sampleHeroId, 3, 4, { from: accounts[0] })
          await hm.addItem(sampleHeroId, 4, 5, { from: accounts[0] })
          await hm.addItem(sampleHeroId, 5, 6, { from: accounts[0] })
          return instance.getHero(sampleHeroId)
        })
        .then(function(val) {
